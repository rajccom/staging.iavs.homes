...
<div class="card shadow-sm one-sec-img-text overflow-hidden rounded"><div class="geeks">
  ...
  <div class="card-body text-center mx-4 pb-4">
  <h6 class="card-title">U-Shape kitchen</h6>
...
<section class="carousel-section">
  ...
  <div class="nonloop owl-carousel owl-theme">
            <div class="item shadow-sm">
            <a href="designer-hardware/products.php?category=Mortise-Handle">
            <div class="card one-sec-img-text">
...
<div class="item shadow-sm">
  ...
  <div class="card-body text-center px-4 pb-4 bg-light">
  <h6 class="card-title">Cylinders</h6>
...
<section class="carousel-section">
  ...
  <div class="btn btn-link">See Collection <i class="fa fa-chevron-right" aria-hidden="true"></i></div>
            ...
            <div class="item shadow-sm">
			<a href="sanitaryware/products.php?category=Bathtubs">
            <div class="card one-sec-img-text">
...
<section class="carousel-section">
  ...
  <div class="nonloop owl-carousel owl-theme">
            <div class="item shadow-sm">
            <a href="tiles/products.php?category=Floor Tiles">
            <div class="card one-sec-img-text">
  ...
  <div class="btn btn-link">See Collection <i class="fa fa-chevron-right" aria-hidden="true"></i></div>
            ...
            <div class="item shadow-sm">
			<a href="tiles/products.php?category=Wall-Tiles">
            <div class="card one-sec-img-text">
...
<section class="carousel-section">
  ...
  <div class="btn btn-link">See Collection <i class="fa fa-chevron-right" aria-hidden="true"></i></div>
            ...
            <div class="item shadow-sm">
			<a href="bath-fittings/products.php?category=Over-Head-Showers">
            <div class="card one-sec-img-text">
...
<div class="item shadow-sm">
<a href="bath-fittings/products.php">
<div class="card one-sec-img-text">
